...
| Project | Description | Skills |
|---|---|---|
| [**OpenSpot**](https://github.com/Darcythiam/Openspot_2022) | Backend system for smart parking with REST APIs, optimized queries, Docker, and AWS deployment (ECS/ECR) | Backend · databases · cloud deployment |
| [**Toons Flag Chase**](https://github.com/Darcythiam/toons-flag-chase) | Multithreaded C++ simulation using `std::thread`, synchronization, and shared-state coordination on a grid-based system | Concurrency · systems programming |

### DevOps & Deployment

| Project | Description | Skills |
|---|---|---|
| [**PITRON**](https://github.com/Darcythiam/PITRON) | Engineering consultancy site deployed via AWS S3 + CloudFront with GitHub Actions CI/CD pipeline | Cloud · CI/CD · deployment |
...
<p align="center">
  <i>Open to full-time roles and internships in ML Engineering, Backend Development, and Cloud/DevOps.</i><br/>
  <b>Let's connect → <a href="mailto:darcyirakoze6@gmail.com">darcyirakoze6@gmail.com</a></b>
</p>
